<script>
  ...
  export default {
    ...
    data () {
      return {
        chartTitle: 'Pump Station Observed Discharge (cumecs)',
        chartId: 'pump-observed-timeseries',
        baseUrl: 'https://uwasp.award.org.za/app_json/uwasp_dash/pump_observed.php'
      };
    },
    methods: {
      fetchChartData () {
