<script>
  ...
  export default {
    ...
    data () {
      return {
        chartTitle: 'Stewards Expected Discharge (cumecs)',
        chartId: 'stewards-expected-timeseries',
        baseUrl: 'https://uwasp.award.org.za/app_json/uwasp_dash/stewards_expected.php'
      };
    },
    methods: {
      fetchChartData () {
