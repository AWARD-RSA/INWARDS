    ...
    <div class="card rounded-0 box">
      ...
      <script type="text/javascript">
        ...
        export default {
          ...
          methods: {
            showRiskTable () {
              this.$http.get('https://inwards.award.org.za/app_json/wq_dash/rqos/compliance_table.php?stations=X2I050&sd=1972-12-10&ed=2022-11-28&type=0&variable=EC_Phys_Water&unit=mg%2FL&merge=true&type=Rivers')
                .then(
                  response => {
